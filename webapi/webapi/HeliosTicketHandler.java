...
public class HeliosTicketHandler
{
  ...
  private static final String GET_URL = "http://heliosuatapi.netmagicsolutions.com:8080/nbss-erp-webservice-1.0/ticketAPI/tickets/widget/count";
  
  private static final int mainCustomerId = 1409;
  private static final int associateCustomerId = 1409;
  ...
  
  {
    ...
    */
    ...
    try
    {
      ...
      json.put("accessKey", "fdf4dfdfgf");
      json.put("mainCustomerId", "1049");
      json.put("associateCustomerId", "1049");
    ...
    {
      System.out.println("Get: json exception!!");
...
/* START createTicket */
  ...
  {   
    ...
    try
    {
      ...
      json.put("resource", "realNiagaraPointName comes here for test - fully qualified niagara ORD");
      json.put("severity", "1");
      ...
      //"2017-11-03 06:29:16"
      System.out.println("GST time:"+timeStamp);

      
      json.put("time_of_event", timeStamp);
      json.put("description", "Java-TestCode-From-Laptop: LAB1_FAN OffNormal Alarm Event");
